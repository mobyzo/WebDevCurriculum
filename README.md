# Knowre web development curriculum 2020


## 소개
* Knowre의 신입 웹 개발자 교육을 위한 웹 개발 교육 커리큘럼의 2020년 버전입니다.
...
* 퀘스트는 다음과 같이 구성되어 있습니다(그러나 모든 퀘스트가 다음의 구성요소들을 모두 가지고 있는 것은 아닙니다).
  ...
  * Resources: 해당 토픽을 익히기 위해 참고하면 좋을 책이나 링크들입니다. 공식 문서를 가장 추천하나 초보자의 입장에서는 어려울 수 있습니다. 본인이 이해될 때까지 구글링을 반복하며 추가적인 자료를 찾아보는 것이 본인의 성장에 도움이 될 것입니다.
...
* 일반적으로 이 커리큘럼을 수행하는 기간은 2개월 내외로 잡고 있습니다. Knowre에서 이 커리큘럼이 진행될 경우, 한 퀘스트를 끝내고 피드백을 받으며 다음 퀘스트의 목표 날짜를 잡는 식으로 진행하고자 합니다.
